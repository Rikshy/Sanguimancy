...
public class RenderBloodInterface extends TileEntitySpecialRenderer<TileBloodInterface> {
    ...
    @Override
    public void render(TileBloodInterface te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        renderModel(te, x, y, z);
        GL11.glPushMatrix();
        ItemStack displayItem = te.getInventory(null).getStackInSlot(0);
